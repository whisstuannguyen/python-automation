...
const btn_copy1 = document.getElementById('btn-copy1')
const btn_copy2= document.getElementById('btn-copy2')
...
label1.addEventListener('click', () => {
  if (textarea1.style.display === 'none' || textarea.style.display === '') {
      ...
      btn_copy1.style.display = 'block';
  } else {
      textarea1.style.display = 'none';
      btn_copy1.style.display = 'none';
  }
});
...
label2.addEventListener('click', () => {
  if (textarea2.style.display === 'none' || textarea.style.display === '') {
      ...
      btn_copy2.style.display = 'block';
  } else {
      textarea2.style.display = 'none';
      btn_copy2.style.display = 'none';
  }
});